...
Modifiable sequences of characters are represented using objects of type <<ref_string>>.

The interface and functionality of <<ref_string>> is the same as {std_string} except that:
