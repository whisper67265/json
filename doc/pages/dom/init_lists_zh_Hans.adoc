...
= Initializer Lists Initializer lists can be used to construct or assign a <<ref_value>>:
...
Initializer lists can be used to unambiguously construct or assign an <<ref_object>> or <<ref_array>>:
